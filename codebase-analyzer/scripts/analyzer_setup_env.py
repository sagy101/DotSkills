...
Usage:
    python3 analyzer_setup_env.py
    python3 analyzer_setup_env.py --venv-dir .codebase-analyzer-venv
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Set up Python environment for codebase-analyzer")
    parser.add_argument(
        "--venv-dir",
