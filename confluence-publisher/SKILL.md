...
Apply targeted find/replace edits to a page's storage HTML without overwriting the entire page. Also supports structural element replacement (tables, sections, lists), markdown-to-HTML section replacement, and appending new sections.
...
**Always use `--dry-run` first.** Full usage details: [references/SURGICAL_EDIT.md](references/SURGICAL_EDIT.md)
...
**Never revert without showing the dry-run plan first.** Full usage details: [references/VERSION_MANAGEMENT.md](references/VERSION_MANAGEMENT.md)
