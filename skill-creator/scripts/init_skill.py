...
Examples:
    ...
    init_skill.py my-skill --path skills/public --openai-yaml --interface short_description="Short UI label"
"""
...
def init_skill(
    ...
    print_next_steps(skill_name, skill_dir, resources, include_examples, generate_openai)
